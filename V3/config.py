...
class Config(ABC):
    def __init__(self,deploy_to,wallet,contracts):
...
class Ropsten():
    '''
    Addresses and ABI for calling contracts on the Ropsten Testnet.
    '''
    def __init__(self):
        self.deploy_to = 'https://ropsten.infura.io/v3/01fd207f78e64967af6443941947b977'
        self.wallet = {
            "address": "0xE533133C7a4Da33f7a54CBa414d5D25ac8eE4524",
        ...
        self.contracts = dict(V3Factory={"address": "0x273Edaa13C845F605b5886Dd66C89AB497A6B17b",
                              ...
                              nftDescriptorLibrary={"address": "0x8b96635D10A4034eC6E146A7c1129FCfa08A47D3",
                                                    "abi": ""},
                              nonfungibleTokenPositionDescriptor={"address": "0xEAC3e2e3098b6F2766CFB302d4106Bd8D6E38540",
                                                                  "abi": ""},
